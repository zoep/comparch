...
do
	...
	/home/zoo/simics-workspace/simics -stall -e '$LINESNO'=$linesno -e '$LINESZ'=128 -e '$ASSOC'=4 -x gzip.simics exit &> l2results/gzip-${cashesize}-128-4.txt
...
do
	...
	/home/zoo/simics-workspace/simics -stall -e '$LINESNO'=$linesno -e '$LINESZ'=128 -e '$ASSOC'=16 -x gzip.simics exit &> l2results/gzip-${cashesize}-128-16.txt
